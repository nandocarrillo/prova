...
def suma_lista(argv):        
    ...
    if len(sys.argv) > 1:                # Si hay parámetros aparte del nombre del archivo
        total = int(sys.argv[1])         #   guardo el primer parámetro numérico
        
        for i in range(2,len(sys.argv),2): # recorro los operadores de la lista
        ...
        print("No has introducido parámetros...")
